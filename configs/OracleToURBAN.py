from albumentations import HorizontalFlip, VerticalFlip, RandomRotate90, Normalize, RandomCrop,Resize
from albumentations import OneOf, Compose,RandomScale
import ever as er
...
val_dir = dict(
    image_dir=[
        BASE+'LoveDA/Val/Urban/images_png/',
    ],
    mask_dir=[
        BASE+'LoveDA/Val/Urban/masks_png/',
    ],
)
test_dir = dict(
    image_dir=[
        BASE+'LoveDA/Test/Urban/images_png/',
    ]
)
